...
// slave reset: 10:               53 
// MOSI:        11:               51 (Use Pin 4 when programming non-AVR chips)
// MISO:        12:               50 (Use Pin 2 when programming non-AVR chips)
// SCK:         13:               52 
//
...
if(MOSI, HIGH)
{
  digitalWrite(MOSIg, LOW);
}
if(MISO, HIGH)
{
  digitalWrite(MISOg, LOW);
}
 if(MOSI, LOW)
{
  digitalWrite(MOSIg, HIGH);
}
if(MISO, LOW)
{
  digitalWrite(MISOg, HIGH);
}
}
